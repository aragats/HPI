...
%In the past semester the IT security team of the chair "Internet Technologies and Systems" worked on the project "Machine Learning for Security Analytics powered by SAP HANA". 
...
\centering
%%[width=90mm]
\includegraphics[width=0.9\textwidth]{figures/simulator_architecture.png}
...
%\begin{figure}
%\centering
%\epsfig{file=figures/simulator_architecture.eps}
%\caption{Simulator's architecture}
%\end{figure}
...
Open the logon window                                                                               & \begin{tabular}[c]{@{}l@{}}{[}'ctrl-alt-del', 'alt-w', 'right', 'right', 'right', 'right', 'enter'{]}\end{tabular}       \\ \hline
...
%\begin{figure}
%\centering
%\epsfig{file=figures/active_directory_logs_result.eps}
%\caption{Active Directory's logs}
%\end{figure}
